...
layout: HubPage
hide_bc: true
title: Microsoft Flow 설명서 | Microsoft Docs
description: Microsoft Flow는 자주 사용하는 앱과 서비스 사이에 자동화된 워크플로를 만들어 파일 동기화, 알림 수신, 데이터 수집 등의 작업을 수행하는 데 도움이 되는 서비스입니다.
keywords:
- Microsoft Flow
- 워크플로
- 흐름
                    ...
                    <div class="cardSize">
                        <div class="cardPadding">
                            <div class="card">
                                ...
                                <div class="cardText">
                                    <span class="likeAnH3">모든 문서 보기</span>
                                </div>
                            </div>
                        </div>
                    </div>
...
<div class="container">
    <h1>Microsoft Flow 설명서</h1>
    <ul class="pivots">
        <li>
            <a href="#start">초보자인 경우</a>
            <ul id="start">
                <li>
                    <a href="#start-all"></a>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>기본 사항 시작</h3>
                                            <p>Microsoft Flow로 일과 생활의 자동화를 시작하는 빠른 방법을 알아봅니다.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>모바일 앱 알아보기</h3>
                                            <p>언제 어디서나 자동화된 워크플로우를 관리, 추적, 탐색할 수 있습니다.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>2분 안에 단추 흐름 만들기</h3>
                                            <p>단추 흐름을 사용하여 반복적인 작업을 자동화하고 실행하는 방법을 알아봅니다.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>일주일의 흐름 확인</h3>
                                            <p>Microsoft Flow 팀에서 바로 새로운 요령을 알아보세요.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>승인 흐름 만들기</h3>
                                            <p>여러 서비스에서 문서 또는 프로세스의 승인을 관리하는 흐름을 만드는 방법을 알아봅니다.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>팀 흐름에서 공동 작업</h3>
                                            <p>Microsoft Flow를 사용하면 반복적인 작업을 쉽게 자동화할 수 있습니다. 소유자로 사용자 또는 그룹을 추가하고 공동 작업을 수행하여 흐름을 디자인하고 관리할 수 있습니다.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>다른 사용자가 단추 흐름을 사용하도록 함</h3>
                                            <p>다른 사람이 사용자의 단추를 사용하여 시간을 절약할 수 있도록 단추를 다른 사용자와 공유하세요.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>흐름 문제 해결</h3>
                                            <p>다음은 문제가 발생하여 자세히 살펴보아야 할 경우에 대한 팁입니다.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>식을 사용하여 흐름 미세 조정</h3>
                                            <p>식과 조건을 사용하여 여러 값을 비교하는 방법을 알아봅니다.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>조직의 Microsoft Flow 관리</h3>
                                            <p>Microsoft Flow에서 환경을 만들고 사용하고 관리하는 방법을 알아봅니다.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>흐름과 REST API를 사용하는 방법 알아보기</h3>
                                            <p>자신의 응용 프로그램에서 Microsoft Flow를 호출합니다.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>사용자 지정 커넥터 만들기</h3>
                                            <p>Azure Logic Apps, Microsoft Flow 또는 Microsoft PowerApps에서 사용할 수 있는 사용자 지정 커넥터를 빌드합니다.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>데이터 손실 방지</h3>
                                            <p>조직의 데이터를 보호하기 위한 정책을 정의합니다.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>흐름에 대한 인사이트 얻기</h3>
                                            <p>분석 대시보드에서 흐름의 상태에 대한 인사이트를 얻습니다.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
